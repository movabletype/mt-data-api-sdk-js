module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        preprocess: {
            "data-api-browser": {
                dest: "mt-static/data-api/v3/js/mt-data-api.js",
                src: "src/data-api/v3/mt-data-api.js"
            },
            "data-api-node": {
                dest: "node-lib/data-api/v3/node-mt-data-api.js",
                src: "src/data-api/v3/node-mt-data-api.js"
            },
            "node-bootstrap": {
            ...
            "data-api-coverage-endpoints": {
                ...
                src: "src/data-api/v3/endpoints.js"
            }
        },
        watch: {
            "data-api": {
        ...
        uglify: {
            "data-api-browser": {
                files: {
                    "mt-static/data-api/v3/js/mt-data-api.min.js": [
                        "mt-static/data-api/v3/js/mt-data-api.js"
                    ]
                },
                options: {
                    banner: "/* Copyright (c) 2013-2015 Six Apart, Ltd.\n * This file is generated by Movable Type DataAPI SDK for JavaScript.\n * Consult the source files for their respective licenses and copyrights.\n * <%= pkg.homepage %>\n */\n",
                    sourceMap: "mt-static/data-api/v3/js/mt-data-api.min.map",
                    sourceMapPrefix: 4,
