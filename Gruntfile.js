module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        preprocess: {
            "data-api-browser": {
                dest: "mt-static/data-api/v5/js/mt-data-api.js",
                src: "src/data-api/v5/mt-data-api.js"
            },
            "data-api-node": {
                dest: "node-lib/data-api/v5/node-mt-data-api.js",
                src: "src/data-api/v5/node-mt-data-api.js"
            },
            "node-bootstrap": {
            ...
            "data-api-coverage-endpoints": {
                ...
                src: "src/data-api/v5/endpoints.js"
            }
        },
        watch: {
            "data-api": {
        ...
        uglify: {
            "data-api-browser": {
                files: {
                    "mt-static/data-api/v5/js/mt-data-api.min.js": [
                        "mt-static/data-api/v5/js/mt-data-api.js"
                    ]
                },
                options: {
                    ...
                    sourceMap: "mt-static/data-api/v5/js/mt-data-api.min.map",
                    sourceMapPrefix: 4,
        ...
        jasmine: {
            "data-api": {
                src: ["mt-static/data-api/v5/js/mt-data-api.js"],
                options: {
                    specs: "spec/data-api/**/*.js",
                    host: "http://localhost:<%= connect.jasmine.options.port %>/",
                    helpers: [
