module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        preprocess: {
            "data-api-browser": {
                dest: "mt-static/data-api/v4/js/mt-data-api.js",
                src: "src/data-api/v4/mt-data-api.js"
            },
            "data-api-node": {
                dest: "node-lib/data-api/v4/node-mt-data-api.js",
                src: "src/data-api/v4/node-mt-data-api.js"
            },
            "node-bootstrap": {
            ...
            "data-api-coverage-endpoints": {
                ...
                src: "src/data-api/v4/endpoints.js"
            }
        },
        watch: {
            "data-api": {
        ...
        uglify: {
            "data-api-browser": {
                files: {
                    "mt-static/data-api/v4/js/mt-data-api.min.js": [
                        "mt-static/data-api/v4/js/mt-data-api.js"
                    ]
                },
                options: {
                    banner: "/* Copyright (c) 2013-2018 Six Apart, Ltd.\n * This file is generated by Movable Type DataAPI SDK for JavaScript.\n * Consult the source files for their respective licenses and copyrights.\n * <%= pkg.homepage %>\n */\n",
                    sourceMap: "mt-static/data-api/v4/js/mt-data-api.min.map",
                    sourceMapPrefix: 4,
        ...
        jasmine: {
            "data-api": {
                src: ["mt-static/data-api/v4/js/mt-data-api.js"],
                options: {
                    specs: "spec/data-api/**/*.js",
                    host: "http://localhost:<%= connect.jasmine.options.port %>/",
                    helpers: [
